...
provide {how-many: how-many, du-dir: du-dir, can-find: can-find, fynd: fynd-take-2} end

#| 

    Does not obey: Fynd: There should be a path for each occurrence (can return multiple paths, must be complete)
    Instead: Returns at most 2 paths
|#
...
fun fynd-take-2(directory :: Dir, name :: String) -> List<Path>:

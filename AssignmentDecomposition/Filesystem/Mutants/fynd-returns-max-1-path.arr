...
provide {how-many: how-many, du-dir: du-dir, can-find: can-find, fynd: fynd-take-1} end

#| 

    Does not obey: Fynd: There should be a path for each occurrence (can return multiple paths, must be complete)
    Instead: Returns at most one path
|#
...
fun fynd-take-1(directory :: Dir, name :: String) -> List<Path>:
    
  n = 1
  res = fynd(directory, name)

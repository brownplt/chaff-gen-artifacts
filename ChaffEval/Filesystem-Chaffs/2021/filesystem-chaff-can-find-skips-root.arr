...
#| chaff (tdelvecc, Aug 31, 2020): 
    Can-find does not return true if file is in root directory.
...
# CHAFF DIFFERENCE: Skips the files in the root directory.
fun can-find(directory :: Dir, name :: String) -> Boolean:
  for any(a-dir from directory.ds):
    can-find-correct(a-dir, name)
  end
end

fun can-find-correct(directory :: Dir, name :: String) -> Boolean:
